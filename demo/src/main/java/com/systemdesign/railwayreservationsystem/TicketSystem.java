...
public class TicketSystem {
    ...
    public void bookTicket(String name, int age, String gender, String berthPreference) {
        ...
        if (!availableBerths.isEmpty()) {
            String allottedBerth = allocateBerth(age, gender, berthPreference);
            passenger = new Passenger(name, age, gender, berthPreference, allottedBerth, ticketId);
            ...
            // if berth, RAC, Waiting list are full then
    ...
    public void cancelTicket(String ticketId) {
        Optional<Passenger> passengerOpt = confirmedPassengers.stream().filter(p -> p.getTicketId().equals(ticketId))
                .findFirst();
        ...
        if (passengerOpt.isPresent()) {
            ...
            if (!racQueue.isEmpty()) {
                ...
                String allocatedBerth = allocateBerth(racPassenger.getAge(), racPassenger.getGender(),
                        racPassenger.getBerth());
                racPassenger.setAllotedBerth(allocatedBerth);
            ...
            if (!waitingListQueue.isEmpty()) {
                ...
                waitingPassenger.setAllotedBerth("RAC");
